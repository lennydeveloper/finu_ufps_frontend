    ...
    >
      <div class="flex items-center justify-around mt-8">
        <div class="flex items-center">
          <img src="https://github.com/lennydeveloper/finu_ufps_frontend/assets/90154644/9ae4bdf4-3512-43b7-b1b3-ad655bfe5a39" alt="logo_ufps">
      ...
      <nav class="mt-10">
        <router-link
          v-if="user.hasOwnProperty('rol') && user.rol.id == 1"
